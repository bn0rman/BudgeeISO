...
import { getClientUser, isClientAuthenticated } from "@/lib/supabase-client";
...
export function MarketingLayout({ children }: { children: React.ReactNode }) {
  ...
  // Only render the children on dashboard pages
  if (isDashboardPage) {
    return <>{children}</>;
  }
  ...
  return (
    <>
            ...
            {!authenticated ? (
              ...
              <div className="flex items-center gap-3">
                ...
                <div className="flex flex-col">
                  ...
                  <Link href="/auth/signout" prefetch={false} className="text-xs text-muted-foreground hover:text-foreground">
                    Log out
                  </Link>
                </div>
              </div>
      ...
      <footer className="container mx-auto px-4 mt-24 border-t border-gray-200 pt-10 pb-16">
        <div className="grid grid-cols-2 md:grid-cols-4 gap-8">
          <div>
            <h3 className="font-bold mb-4">Budgee ISO</h3>
            <p className="text-sm text-muted-foreground">
              Making ISO27001 certification accessible for businesses of all sizes.
            </p>
          </div>
        ...
        <div className="mt-10 pt-6 border-t border-gray-200 flex flex-col md:flex-row justify-between items-center">
          <p className="text-sm text-muted-foreground">
            © 2023 Budgee ISO. All rights reserved.
          </p>
